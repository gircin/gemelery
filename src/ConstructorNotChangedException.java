 ...
 * The formsQuantity constant from the GemForm class
 * is used the length of the enumeration array of its class.
 * The same constant in the GemSize class
 * is set manually in the code, to ensure that the constructor is changed.
 * /
